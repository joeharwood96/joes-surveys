...
elseif (isset($_POST['email']))
{
	...
	{		
		...
		// check to see if this user is already a user
...
//show account form if true 
if ($show_account_form)
{
echo <<<_END
<h2>Update your profile info:</h2><br>
<div class="container">
<form action="account.php?username=$username" method="post" class="form-group">
  Username: {$_SESSION['username']}
  <br>
