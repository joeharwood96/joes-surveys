...
elseif (isset($_POST['username']))
{
	...
	$doa_val = validateDOB($dob);
	$telephone_val = validateString($telephone, 1, 15);
	...
	$errors = $username_val . $password_val . $email_val . $firstname_val . $lastname_val . $doa_val . $telephone_val;
	...
	if ($errors == "")
	{
		...
		$query = "INSERT INTO users (firstname, lastname, username, password, email, telephone, dateofbirth) VALUES ('$firstname', '$lastname', '$username', '$password', '$email', '$telephone', '$dob');";
...
<form action="sign_up.php" method="post" class="form-group">
  ...
  Fistname: <input type="text" name="firstname" minlength="1" maxlength="16" value="$firstname" class="form-control" required> $firstname_val
  <br>
  Lastname: <input type="text" name="lastname" minlength="1" maxlength="16" value="$lastname" class="form-control" required> $lastname_val
  <br>
  Username: <input type="text" name="username" minlength="1" maxlength="16" value="$username" class="form-control" required> $username_val
  <br>
  Password: <input type="password" name="password" minlength="1" maxlength="16" value="$password" class="form-control" required> $password_val
  <br>
  Email: <input type="email" name="email" minlength="1" maxlength="64" value="$email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" required> $email_val
  <br>
  Date of birth: <input type="date" name="dob" value="$dob" class="form-control" required> $dob
  <br>
  Telephone: <input type="text" name="telephone" minlength="1" maxlength="16" value="$telephone" class="form-control" required> $telephone_val
  <br>
